...
def create_tasks(researcher, profiler, resume_strategist, interview_preparer, 
                job_posting_url, github_url, personal_writeup, session_id):
    """
    Create and return the tasks needed for the job application crew
    """
    ...
    profile_task = Task(
        description=(
            ...
            f"using the GitHub ({github_url}) URL, and personal write-up "
